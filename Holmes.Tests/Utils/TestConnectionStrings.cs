...
namespace Holmes.Tests.Utils
{
    internal static class TestConnectionStrings
    {
        ...
        {
            var sqlPassword = Environment.GetEnvironmentVariable("HOLMES_SQL_PASSWORD");
            ...
            var sqlServer = Environment.GetEnvironmentVariable("HOLMES_SQL_SERVER");
