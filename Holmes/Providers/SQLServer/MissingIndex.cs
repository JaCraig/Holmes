...
{
    /// <summary>
    /// Makes suggestions on missing indexes
    /// </summary>
    /// <seealso cref="IAnalyzer"/>
    public class MissingIndex : AnalyzerBaseClass
    {
        /// <summary>
...
ORDER BY Avg_Estimated_Impact DESC";
        ...
        {
            return results.Select(x => new Finding($"Suggested index creation for {x.TableName}.", x, x.Create_Statement, FindingSeverity.Warning, "Index"));
        }
    }
}